package com.fido.common.common_base_util.util.market;
...
public class MarketUtils {
     ...
     * 不获取app 安装列表的方式
     */
    public void openMarketDetail(Context context){
        try{
            Uri uri = Uri.parse(schemaUrl + context.getPackageName());
    ...
    public boolean startMarket(Context mContext, String packageName) {
        try {
            ...
            if (TextUtils.isEmpty(brandName)) {
                LogUtils.INSTANCE.e("MarketUtils", "没有读取到手机厂商~~");
                return false;
            }
            ...
            LogUtils.INSTANCE.e("MarketUtils", "要跳转的应用市场不存在!");
        } catch (Exception e) {
            LogUtils.INSTANCE.e("MarketUtils", "其他错误：" + e.getMessage());
        }
        return false;
    }
