package com.fido.common.common_base_util.log
...
object LogUtils {
    ...
    fun gson(msg: Any,customTag: String=""){
        log(Log.ERROR,customTag,msg.toJson())
    }
    ...
    private fun findIndex(elements: Array<StackTraceElement>): Int {
        ...
        while (index < elements.size) {
            ...
            if (className != LogUtils::class.java.name && !elements[index].methodName.startsWith("log")) {
                return index
            }
            index++
        }
