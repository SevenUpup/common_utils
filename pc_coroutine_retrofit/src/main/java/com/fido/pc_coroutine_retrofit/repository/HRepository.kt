package com.fido.pc_coroutine_retrofit.repository

import com.fido.pc_coroutine_retrofit.net.NetWorkApi
import com.fido.pc_coroutine_retrofit.net.retrofit.RequestBodyWrapper
import com.fido.pc_coroutine_retrofit.net.retrofit.RetrofitUtils
import com.fido.pc_coroutine_retrofit.parseErrorString
 ...
 * @des:
 */
class HRepository private constructor(){

    companion object{
        val instance by lazy { HRepository() }
